...
// shortestSpan() and longestSpan() They will respectively find out 
// the shortest span or the longest span (or distance, if you prefer) between all the numbers stored, and return it. 
...
// Test your Span at least with a minimum of 10000 numbers. More would be even better.
