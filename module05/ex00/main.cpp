...
int main()
{
    ...
    Sullyoon.decrement();
    Sullyoon.decrement();
    std::cout << "Sullyoon's Grade up   " << Sullyoon.getGrade() << "\n";
    Bae.increment();
    Bae.increment();
    std::cout << "Bae's Grade down      " << Bae.getGrade() << "\n";


    std::cout << "\n";
    std::cout << "\n";
    Bureaucrat *operator_check = new Bureaucrat("eunjeong", 33);
    std::cout << operator_check;
}